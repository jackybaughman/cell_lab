# -*- coding: utf-8 -*-
"""
Created on Tue Apr 12 08:39:36 2016
...
Modified by JSB, April 2016
Modeling magma flow in earth's crust...sortof. Still have 2 phases - rock and 
magma. Magma is less dense than rock so there is no downward motion, also 
preferentially taken advantage of my pretend weak rock to the left...would be 
cool to actually put fractures in!

Very simple - very few changes to Greg's code, but fun to try to understand
how this works! Seems pretty cool, and great code to jump off from!

Starts as flat magma chamber - then ascends, leaves you with decent reservoir,
conduit and perhaps upper bound is the surface or a less dense layer that 
preferentially pools the magma again...use your imagination!
...
def setup_transition_list():
    ...
    transitions for a biased random walk, in which the rate of leftward
    motion is greater and there is no downward motion.
    ...
    Notes
    -----
    State 0 represents country rock and state 1 represents a magma 
    
    The states and transitions are as follows:
    Pair state      Transition to       Process             Rate (cells/s)
    ==========      =============       =======             ==============
    0 (0-0)         (none)              -                   -
    1 (0-1)         2 (1-0)             left motion         30.0
    2 (1-0)         1 (0-1)             right motion        10.0
    3 (1-1)         (none)              -                   -
    4 (0-0)         (none)              -                   -
    5 (0-1)         none                -                   -
    6 (1-0)         1 (0-1)             up motion            15
    7 (1-1)         (1-1)               up motion            15
    ...
    #  - Name for transition
    xn_list.append( Transition((0,1,0), (1,0,0), 30., 'left motion') )
    xn_list.append( Transition((1,0,0), (0,1,0), 10., 'right motion') )
    #xn_list.append( Transition((0,1,1), (1,0,1), 10.55, 'down motion') )
    xn_list.append( Transition((1,0,1), (0,1,1), 15, 'up motion') )
    xn_list.append( Transition((1,1,1), (1,1,1), 15, 'up motion') )
...
def main():
    ...
    run_duration = 25.0   # duration of run, sec
    ...
    ns_dict = { 0 : 'country rock', 1 : 'magma' }
